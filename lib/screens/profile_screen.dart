...
import 'package:pixelx/screens/edit_profile_screen.dart';
// import 'package:pixelx/screens/first_screen.dart';
    ...
    return Row(
      ...
      children: <Widget>[
        IconButton(
          ...
          iconSize: 30.0,
          color: _displayPosts == 0 ? Colors.black : Colors.grey[600],
          onPressed: () => setState(() {
            _displayPosts = 0;
          }),
        ),
        IconButton(
          ...
          iconSize: 30.0,
          color: _displayPosts == 1 ? Colors.black : Colors.grey[600],
          onPressed: () => setState(() {
            _displayPosts = 1;
          }),
        ),
